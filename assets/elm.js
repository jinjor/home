...
var _etaque$elm_route_parser$RouteParser_Parser$stringParam = A2(
	_Bogdanp$elm_combine$Combine_ops['<$>'],
...
var _etaque$elm_route_parser$RouteParser_Parser$queryStringParam = A2(
	_Bogdanp$elm_combine$Combine$andMap,
	_etaque$elm_route_parser$RouteParser_Parser$stringParam,
	A2(
		_Bogdanp$elm_combine$Combine$map,
		F2(
			function (v0, v1) {
		...
		A2(
			...
			_etaque$elm_route_parser$RouteParser_Parser$stringParam,
			_Bogdanp$elm_combine$Combine$string('='))));
var _etaque$elm_route_parser$RouteParser_Parser$queryString = A2(
	_Bogdanp$elm_combine$Combine_ops['*>'],
	_Bogdanp$elm_combine$Combine$string('?'),
	A2(
		_Bogdanp$elm_combine$Combine$sepBy,
		_Bogdanp$elm_combine$Combine$string('&'),
		_etaque$elm_route_parser$RouteParser_Parser$queryStringParam));

var _etaque$elm_route_parser$RouteParser_QueryString$fromList = function (items) {
	var addItem = F2(
		function (_p0, dict) {
			var _p1 = _p0;
			var _p2 = _p1._0;
			var keyValues = A2(
				...
				{ctor: '[]'},
				A2(_elm_lang$core$Dict$get, _p2, dict));
			return A3(
				_elm_lang$core$Dict$insert,
				_p2,
				{ctor: '::', _0: _p1._1, _1: keyValues},
				dict);
		});
	return A3(_elm_lang$core$List$foldr, addItem, _elm_lang$core$Dict$empty, items);
};
var _etaque$elm_route_parser$RouteParser_QueryString$parse = function (s) {
	var _p3 = A2(_Bogdanp$elm_combine$Combine$parse, _etaque$elm_route_parser$RouteParser_Parser$queryString, s);
	if ((_p3.ctor === 'Ok') && (_p3._0.ctor === '_Tuple3')) {
		return _etaque$elm_route_parser$RouteParser_QueryString$fromList(_p3._0._2);
	} else {
...
var _user$project$Core$andThen = F2(
	function (f, _p0) {
		var _p1 = _p0;
		var _p2 = f(_p1._0);
		var newModel = _p2._0;
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('repository-card-stats-language-color'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$href(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'https://github.com/',
													A2(_elm_lang$core$Basics_ops['++'], repos.fullName, '/stargazers'))),
											_1: {
												ctor: '::',
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Attributes$href(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'https://github.com/',
														A2(_elm_lang$core$Basics_ops['++'], repos.fullName, '/network'))),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$target('_blank'),
													_1: {ctor: '[]'}
...
var _user$project$GitHub$decodeUser = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$GitHub$User,
	...
	A2(_elm_lang$core$Json_Decode$field, 'followers', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'following', _elm_lang$core$Json_Decode$int),
...
var _user$project$SmfDecoder$Tempo = function (a) {
...
var _user$project$SmfDecoder$meta = function (tipe) {
	return A2(
		_user$project$BinaryDecoder$andThen,
		function (length) {
			return _elm_lang$core$Native_Utils.eq(tipe, 47) ? _user$project$BinaryDecoder$succeed(_user$project$SmfDecoder$End) : (_elm_lang$core$Native_Utils.eq(tipe, 81) ? A2(
				_user$project$BinaryDecoder_ops['|='],
				A2(
					_user$project$BinaryDecoder_ops['|='],
					_user$project$BinaryDecoder$succeed(
						F2(
							function (i16, i8) {
								return _user$project$SmfDecoder$Tempo((i16 << 8) + i8);
							})),
					_user$project$BinaryDecoder_Byte$uint16BE),
				_user$project$BinaryDecoder_Byte$uint8) : A2(
				_user$project$BinaryDecoder_ops['|.'],
				_user$project$BinaryDecoder$succeed(
...
var _user$project$Midi$timeToPositionHelp = F4(
	function (timeBase, tempo, time, _p0) {
		timeToPositionHelp:
		while (true) {
			var _p1 = _p0;
			var _p5 = _p1._0;
			...
			var _p2 = tempo;
			if (_p2.ctor === '[]') {
				return _p5 + _elm_lang$core$Basics$round(
					((time * 1000) / _elm_lang$core$Basics$toFloat(_p4)) * _elm_lang$core$Basics$toFloat(timeBase));
			} else {
				var _p3 = _p2._0._0;
				var nextTime = ((_elm_lang$core$Basics$toFloat(_p3 - _p5) / _elm_lang$core$Basics$toFloat(timeBase)) * _elm_lang$core$Basics$toFloat(_p4)) / 1000;
				if (_elm_lang$core$Native_Utils.cmp(nextTime, time) > 0) {
					return _p5 + _elm_lang$core$Basics$round(
						((time * 1000) / _elm_lang$core$Basics$toFloat(_p4)) * _elm_lang$core$Basics$toFloat(timeBase));
				} else {
					var _v2 = timeBase,
						_v3 = _p2._1,
						_v4 = time - nextTime,
						_v5 = {ctor: '_Tuple2', _0: _p3, _1: _p2._0._1};
					timeBase = _v2;
					tempo = _v3;
					time = _v4;
					_p0 = _v5;
					continue timeToPositionHelp;
				}
			}
		}
	});
var _user$project$Midi$tempoOfBpm = function (bpm) {
	return (((60 * 1000) * 1000) / bpm) | 0;
};
var _user$project$Midi$timeToPosition = F3(
	function (timeBase, tempoStack, time) {
		return A4(
			_user$project$Midi$timeToPositionHelp,
			timeBase,
			_elm_lang$core$List$reverse(tempoStack),
			time,
			{
				ctor: '_Tuple2',
				_0: 0,
				_1: _user$project$Midi$tempoOfBpm(120)
			});
	});
var _user$project$Midi$positionToTime = F3(
	function (timeBase, tempoStack, position) {
			...
			A3(
				...
				F2(
					function (_p7, _p6) {
						...
						var _p11 = _p9._1;
						var _p10 = _p9._0;
						return (_elm_lang$core$Native_Utils.cmp(_p12, _p10) > 0) ? {ctor: '_Tuple2', _0: _p10, _1: _p11} : {
							ctor: '_Tuple2',
							_0: _p12,
							_1: _p11 + (((_elm_lang$core$Basics$toFloat(_p10 - _p12) / _elm_lang$core$Basics$toFloat(timeBase)) * _elm_lang$core$Basics$toFloat(_p8._1)) / 1000)
						};
					}),
				{ctor: '_Tuple2', _0: position, _1: 0.0},
				tempoStack));
	});
...
var _user$project$Midi$Midi = F3(
	function (a, b, c) {
		return {timeBase: a, tempo: b, tracks: c};
	});
					...
					case 'Tempo':
						return _elm_lang$core$Native_Utils.update(
							_p22,
							{
								tempo: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: _p23 + _p24, _1: _p17._0},
									_1: _p22.tempo
								}
							});
					case 'NoteOn':
						return _elm_lang$core$Native_Utils.update(
							_p22,
							{
								channel: A2(_elm_lang$core$Basics$max, _p17._0, _p22.channel),
								temporaryNotes: A3(
									_elm_lang$core$Dict$insert,
									_p17._1,
									{ctor: '_Tuple2', _0: _p23 + _p24, _1: _p17._2},
									_p22.temporaryNotes)
							});
					case 'NoteOff':
						var _p21 = _p17._1;
						return _elm_lang$core$Native_Utils.update(
							_p22,
							{
								temporaryNotes: A2(_elm_lang$core$Dict$remove, _p21, _p22.temporaryNotes),
								notes: A2(
									_elm_lang$core$Maybe$withDefault,
									_p22.notes,
									A2(
										...
										function (_p18) {
											...
											return {
												ctor: '::',
												_0: A4(_user$project$Midi$Note, _p20, _p21, _p19._1, (_p23 + _p24) - _p20),
												_1: _p22.notes
											};
										},
										A2(_elm_lang$core$Dict$get, _p21, _p22.temporaryNotes)))
							});
					default:
						return _p22;
				}
...
var _user$project$Midi$Context = F4(
	function (a, b, c, d) {
		return {channel: a, temporaryNotes: b, notes: c, tempo: d};
	});
var _user$project$Midi$initContext = A4(
...
var _user$project$Midi$fromSmf = function (smf) {
	var tempo = A2(
		...
		A2(
			...
			_elm_lang$core$List$head(smf.tracks)));
	var tracks = A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$List$map(_user$project$Midi$fromSmfTrack),
			_elm_lang$core$List$tail(smf.tracks)));
	return A3(_user$project$Midi$Midi, smf.header.timeBase, tempo, tracks);
};
...
var _user$project$WebAudioApi$decodeAudioData = function (_p2) {
	return A2(
		_elm_lang$core$Task$map,
		_user$project$WebAudioApi$AudioBuffer,
...
var _user$project$MidiPlayer$closeButton = function (onClose) {
	return A2(
		...
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$stroke('#ddd'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$strokeWidth('2'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$d('M11,9L25,21zM11,21L25,9z'),
						_1: {ctor: '[]'}
					}
				}
			},
			...
			_elm_lang$svg$Svg$path,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$d('M13,21H23'),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			_elm_lang$svg$Svg$path,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$d('M11,9V21H25V9z'),
							_1: {ctor: '[]'}
						}
					}
				}
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$class('midi-player-display'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$MidiPlayer$centerLine = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('midi-player-center-line'),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _user$project$MidiPlayer$viewLoading = function (maybeOnClose) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('midi-player'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$svg$Svg$svg,
				_user$project$MidiPlayer$svgAttributes(0),
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: A2(
...
var _user$project$MidiPlayer$dropWhile = F2(
	function (f, list) {
		dropWhile:
		while (true) {
			var _p0 = list;
...
var _user$project$MidiPlayer$prepareFutureNotes = F2(
	function (time, midi) {
		return A2(
			_user$project$MidiPlayer$dropWhile,
			function (note) {
				return _elm_lang$core$Native_Utils.cmp(
					A3(_user$project$Midi$positionToTime, midi.timeBase, midi.tempo, note.position),
					time) < 0;
			},
			A2(
				...
				A2(
					...
					function (_p1) {
						...
						return A2(
							_elm_lang$core$List$map,
							A2(_user$project$Midi$addDetails, _p2._0, _p3.channel),
							_p3.notes);
					},
					A2(
						_elm_lang$core$List$indexedMap,
...
var _user$project$MidiPlayer$MidiPlayer = F4(
	function (a, b, c, d) {
		return {playing: a, startTime: b, currentTime: c, futureNotes: d};
	});
var _user$project$MidiPlayer$init = A4(
	_user$project$MidiPlayer$MidiPlayer,
	false,
	0,
	0,
	{ctor: '[]'});
...
var _user$project$MidiPlayer$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$MidiPlayer$subscriptions = function (model) {
	return model.playing ? A2(_elm_lang$core$Time$every, (1000 * _elm_lang$core$Time$millisecond) / 30, _user$project$MidiPlayer$Tick) : _elm_lang$core$Platform_Sub$none;
};
var _user$project$MidiPlayer$Stop = {ctor: 'Stop'};
var _user$project$MidiPlayer$stop = _user$project$MidiPlayer$Stop;
var _user$project$MidiPlayer$Start = F3(
	function (a, b, c) {
...
var _user$project$MidiPlayer$triggerStart = _user$project$MidiPlayer$TriggerStart;
var _user$project$MidiPlayer$playButton = F3(
	function (midi, mp3AudioBuffer, playing) {
		return A2(
			_user$project$MidiPlayer$controlButton,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					playing ? _user$project$MidiPlayer$Stop : A2(_user$project$MidiPlayer$TriggerStart, midi, mp3AudioBuffer)),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$svg$Svg$path,
				{
					...
					_1: {
						ctor: '::',
						_0: playing ? _elm_lang$svg$Svg_Attributes$d('M10,8v14h4v-14zm10,0v14h4v-14z') : _elm_lang$svg$Svg_Attributes$d('M10,8v14l16,-7z'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}));
	});
var _user$project$MidiPlayer$Back = {ctor: 'Back'};
var _user$project$MidiPlayer$back = _user$project$MidiPlayer$Back;
var _user$project$MidiPlayer$backButton = A2(
	_user$project$MidiPlayer$controlButton,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$MidiPlayer$Back),
		_1: {ctor: '[]'}
	},
	A2(
		_elm_lang$svg$Svg$path,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$d('M12,10v10h2v-10zm14,0v10l-12,-5z'),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'}));
var _user$project$MidiPlayer$control = F8(
	function (options, id, title, fullscreen, tracks, midi, mp3AudioBuffer, playing) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
...
var _user$project$MidiPlayer$view = F8(
	function (options, id, title, fullscreen, midi, mp3AudioBuffer, delay, model) {
		var time = (model.currentTime - model.startTime) + delay;
			...
			},
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A8(_user$project$MidiPlayer$control, options, id, title, fullscreen, midi.tracks, midi, mp3AudioBuffer, model.playing),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$MusicContents$encodeDetails = function (details) {
	var _p0 = details;
	switch (_p0.ctor) {
		case 'Mp3':
...
var _user$project$MusicContents$encodeContent = function (content) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(content.id)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'title',
					_1: _elm_lang$core$Json_Encode$string(content.title)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'description',
						_1: _elm_lang$core$Json_Encode$string(content.description)
					},
					_1: {
						ctor: '::',
						_0: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'details',
								_1: _user$project$MusicContents$encodeDetails(content.details)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$MusicContents$encodeContents = function (contents) {
	return _elm_lang$core$Json_Encode$list(
		A2(_elm_lang$core$List$map, _user$project$MusicContents$encodeContent, contents));
};
var _user$project$MusicContents$Content = F5(
	function (a, b, c, d, e) {
		return {id: a, title: b, description: c, image: d, details: e};
	});
var _user$project$MusicContents$SoundCloud = function (a) {
	return {ctor: 'SoundCloud', _0: a};
};
var _user$project$MusicContents$MidiAndMp3 = F3(
	function (a, b, c) {
		return {ctor: 'MidiAndMp3', _0: a, _1: b, _2: c};
	});
var _user$project$MusicContents$Mp3 = function (a) {
	return {ctor: 'Mp3', _0: a};
};
var _user$project$MusicContents$contents = {
	ctor: '::',
	_0: A5(
		_user$project$MusicContents$Content,
		'monday-morning',
		'Monday Morning',
		'',
		_elm_lang$core$Maybe$Nothing,
		A3(_user$project$MusicContents$MidiAndMp3, '2017/monday-morning.mid', '2017/monday-morning.mp3', 1250)),
	_1: {
		ctor: '::',
		_0: A5(
			_user$project$MusicContents$Content,
			...
			_user$project$MusicContents$SoundCloud('318647824')),
		_1: {
			ctor: '::',
			_0: A5(
				_user$project$MusicContents$Content,
				...
				_user$project$MusicContents$SoundCloud('318080873')),
			_1: {
				ctor: '::',
				_0: A5(
					_user$project$MusicContents$Content,
					...
					_user$project$MusicContents$SoundCloud('306090165')),
				_1: {
					ctor: '::',
					_0: A5(
						_user$project$MusicContents$Content,
						...
						A3(_user$project$MusicContents$MidiAndMp3, '2016/hokora.mid', '2016/hokora.mp3', 2770)),
					_1: {
						ctor: '::',
						_0: A5(
							_user$project$MusicContents$Content,
							...
							_elm_lang$core$Maybe$Just('hokora.jpg'),
							_user$project$MusicContents$Mp3('2016/hokora-fc.mp3')),
						_1: {
							ctor: '::',
							_0: A5(
								_user$project$MusicContents$Content,
								...
								'',
								_elm_lang$core$Maybe$Nothing,
								_user$project$MusicContents$SoundCloud('278194362')),
							_1: {
								ctor: '::',
								_0: A5(
									_user$project$MusicContents$Content,
									...
									'',
									_elm_lang$core$Maybe$Nothing,
									_user$project$MusicContents$SoundCloud('240810123')),
								_1: {
									ctor: '::',
									_0: A5(
										_user$project$MusicContents$Content,
										...
										_user$project$MusicContents$Mp3('2016/ancient.mp3')),
									_1: {
										ctor: '::',
										_0: A5(
											_user$project$MusicContents$Content,
											...
											'スマホゲーム [Block Brothers](http://blockbros.net/) BGM',
											_elm_lang$core$Maybe$Just('block.png'),
											_user$project$MusicContents$Mp3('2016/cloud-passage.mp3')),
										_1: {
											ctor: '::',
											_0: A5(
												_user$project$MusicContents$Content,
												...
												_elm_lang$core$Maybe$Just('block.png'),
												_user$project$MusicContents$Mp3('2016/ice-world.mp3')),
											_1: {
												ctor: '::',
												_0: A5(
													_user$project$MusicContents$Content,
													...
													'スマホゲーム [Block Brothers](http://blockbros.net/) 未収録曲',
													_elm_lang$core$Maybe$Just('block.png'),
													_user$project$MusicContents$Mp3('2016/welcome-to-the-jungle.mp3')),
												_1: {
													ctor: '::',
													_0: A5(
														_user$project$MusicContents$Content,
														...
														'スマホゲーム [Block Brothers](http://blockbros.net/) BGM',
														_elm_lang$core$Maybe$Just('block.png'),
														_user$project$MusicContents$Mp3('2016/moon-over-the-castle.mp3')),
													_1: {
														ctor: '::',
														_0: A5(
															_user$project$MusicContents$Content,
															...
															'スマホゲーム [Block Brothers](http://blockbros.net/) 未収録曲',
															_elm_lang$core$Maybe$Just('block.png'),
															_user$project$MusicContents$Mp3('2016/lava-mountain.mp3')),
														_1: {
															ctor: '::',
															_0: A5(
																_user$project$MusicContents$Content,
																...
																'',
																_elm_lang$core$Maybe$Nothing,
																_user$project$MusicContents$SoundCloud('236197155')),
															_1: {
																ctor: '::',
																_0: A5(
																	_user$project$MusicContents$Content,
																	...
																	'',
																	_elm_lang$core$Maybe$Nothing,
																	_user$project$MusicContents$SoundCloud('233781385')),
																_1: {
																	ctor: '::',
																	_0: A5(
																		_user$project$MusicContents$Content,
																		...
																		'自作自演',
																		_elm_lang$core$Maybe$Nothing,
																		_user$project$MusicContents$SoundCloud('228037751')),
																	_1: {
																		ctor: '::',
																		_0: A5(
																			_user$project$MusicContents$Content,
																			...
																			'',
																			_elm_lang$core$Maybe$Nothing,
																			_user$project$MusicContents$SoundCloud('200427994')),
																		_1: {
																			ctor: '::',
																			_0: A5(
																				_user$project$MusicContents$Content,
																				...
																				'',
																				_elm_lang$core$Maybe$Nothing,
																				A3(_user$project$MusicContents$MidiAndMp3, '2014/summer.mid', '2014/summer.mp3', 1420)),
																			_1: {
																				ctor: '::',
																				_0: A5(
																					_user$project$MusicContents$Content,
																					...
																					'',
																					_elm_lang$core$Maybe$Nothing,
																					A3(_user$project$MusicContents$MidiAndMp3, '2014/sakura.mid', '2014/sakura.mp3', 1600)),
																				_1: {
																					ctor: '::',
																					_0: A5(
																						_user$project$MusicContents$Content,
																						...
																						'',
																						_elm_lang$core$Maybe$Nothing,
																						A3(_user$project$MusicContents$MidiAndMp3, '2014/midnight.mid', '2014/midnight.mp3', 540)),
																					_1: {
																						ctor: '::',
																						_0: A5(
																							_user$project$MusicContents$Content,
																							...
																							'',
																							_elm_lang$core$Maybe$Nothing,
																							A3(_user$project$MusicContents$MidiAndMp3, '2013/string.mid', '2013/string.mp3', 840)),
																						_1: {
																							ctor: '::',
																							_0: A5(
																								_user$project$MusicContents$Content,
																								...
																								'',
																								_elm_lang$core$Maybe$Nothing,
																								A3(_user$project$MusicContents$MidiAndMp3, '2013/autumn.mid', '2013/autumn.mp3', 1100)),
																							_1: {
																								ctor: '::',
																								_0: A5(
																									_user$project$MusicContents$Content,
																									...
																									'',
																									_elm_lang$core$Maybe$Nothing,
																									A3(_user$project$MusicContents$MidiAndMp3, '2013/afternoon_caos.mid', '2013/afternoon_caos.mp3', 700)),
																								_1: {
																									ctor: '::',
																									_0: A5(
																										_user$project$MusicContents$Content,
																										...
																										'',
																										_elm_lang$core$Maybe$Nothing,
																										A3(_user$project$MusicContents$MidiAndMp3, '2013/michikusa.mid', '2013/michikusa.mp3', 860)),
																									_1: {
																										ctor: '::',
																										_0: A5(
																											_user$project$MusicContents$Content,
																											...
																											'',
																											_elm_lang$core$Maybe$Nothing,
																											A3(_user$project$MusicContents$MidiAndMp3, '2013/tmp.mid', '2013/tmp.mp3', 1700)),
																										_1: {
																											ctor: '::',
																											_0: A5(
																												_user$project$MusicContents$Content,
																												...
																												'',
																												_elm_lang$core$Maybe$Nothing,
																												A3(_user$project$MusicContents$MidiAndMp3, '2013/hallucination.mid', '2013/hallucination.mp3', 1200)),
																											_1: {
																												ctor: '::',
																												_0: A5(
																													_user$project$MusicContents$Content,
																													...
																													'',
																													_elm_lang$core$Maybe$Nothing,
																													A3(_user$project$MusicContents$MidiAndMp3, '2013/blue.mid', '2013/blue.mp3', 1660)),
																												_1: {
																													ctor: '::',
																													_0: A5(
																														_user$project$MusicContents$Content,
																														...
																														'',
																														_elm_lang$core$Maybe$Nothing,
																														A3(_user$project$MusicContents$MidiAndMp3, '2012/painter.mid', '2012/painter.mp3', 1800)),
																													_1: {
																														ctor: '::',
																														_0: A5(
																															_user$project$MusicContents$Content,
																															...
																															'',
																															_elm_lang$core$Maybe$Nothing,
																															A3(_user$project$MusicContents$MidiAndMp3, '2012/uploar.mid', '2012/uploar.mp3', 0)),
																														_1: {ctor: '[]'}
																													}
																												}
																											}
...
var _user$project$MusicContents$json = _user$project$MusicContents$encodeContents(_user$project$MusicContents$contents);
...
var _user$project$Main$viewPaintings = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$project$Main$soundCloud = function (id) {
	return A2(
		_elm_lang$html$Html$iframe,
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '20'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'scrolling', 'no'),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'frameborder', 'no'),
						_1: {
							ctor: '::',
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('World Maker'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {midiContents: a, selected: b, midiPlayer: c, gitHub: d, fullscreen: e, error: f};
	});
var _user$project$Main$MidiContent = F4(
	function (a, b, c, d) {
		return {midiFile: a, mp3File: b, delay: c, midiAndMp3: d};
	});
var _user$project$Main$initialMidiCountents = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$filterMap,
		function (content) {
			var _p0 = content.details;
			if (_p0.ctor === 'MidiAndMp3') {
				var _p1 = _p0._0;
				return _elm_lang$core$Maybe$Just(
					{
						ctor: '_Tuple2',
						_0: _p1,
						_1: A4(_user$project$Main$MidiContent, _p1, _p0._1, _p0._2, _elm_lang$core$Maybe$Nothing)
					});
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		},
		_user$project$MusicContents$contents));
var _user$project$Main$DecodeError = F2(
	function (a, b) {
		return {ctor: 'DecodeError', _0: a, _1: b};
	});
var _user$project$Main$NoError = {ctor: 'NoError'};
var _user$project$Main$MidiPlayerMsg = function (a) {
	return {ctor: 'MidiPlayerMsg', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$Main$MidiPlayerMsg,
...
var _user$project$Main$midiPlayerOptions = {
	onFullscreen: _user$project$Main$Fullscreen(true),
	onMinimize: _user$project$Main$Fullscreen(false),
	onClose: _user$project$Main$Close,
	transform: _user$project$Main$MidiPlayerMsg,
	playerMode: false
};
var _user$project$Main$viewPlayerHelp = F2(
	function (model, content) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'player-fullscreen', _1: model.fullscreen},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: function () {
					var _p2 = content.details;
					switch (_p2.ctor) {
						case 'Mp3':
							return A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$viewMp3Player, _p2._0);
						case 'MidiAndMp3':
							return A2(
								_elm_lang$core$Maybe$withDefault,
								_elm_lang$html$Html$text(''),
								A2(
									...
									function (midiContent) {
										return A2(
											_elm_lang$core$Maybe$withDefault,
											_user$project$MidiPlayer$viewLoading(
												_elm_lang$core$Maybe$Just(_user$project$Main$Close)),
											A2(
												_elm_lang$core$Maybe$map,
												function (_p3) {
													var _p4 = _p3;
													return A8(_user$project$MidiPlayer$view, _user$project$Main$midiPlayerOptions, content.id, content.title, model.fullscreen, _p4._0, _p4._1, _p2._2, model.midiPlayer);
												},
												midiContent.midiAndMp3));
									},
									A2(_elm_lang$core$Dict$get, _p2._0, model.midiContents)));
						default:
							return A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$viewSoundCloudPlayer, _p2._0);
					}
				}(),
				_1: {ctor: '[]'}
			});
		...
		switch (_p5.ctor) {
						...
						switch (_p6.ctor) {
							...
							case 'MidiAndMp3':
								return A2(
									...
									A3(_user$project$Main$TriggerLoadMidiAndMp3, _p9, _p6._0, _p6._1),
									model);
							default:
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
						...
						function (model) {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										selected: _elm_lang$core$Maybe$Just(_p8)
									}),
								_1: _elm_lang$navigation$Navigation$modifyUrl(
									A2(_elm_lang$core$Basics_ops['++'], '?content=', _p8.id))
							};
						},
						A2(
							_user$project$Core$andThen,
							_p9 ? _user$project$Main$update(
							...
							A2(
								_user$project$Core$andThen,
								_user$project$Main$update(
									_user$project$Main$MidiPlayerMsg(_user$project$MidiPlayer$back)),
								A2(
									_elm_lang$core$Maybe$withDefault,
									...
									A2(
										...
										function (_p7) {
											return A2(
												_user$project$Main$update,
												_user$project$Main$MidiPlayerMsg(_user$project$MidiPlayer$stop),
												model);
										},
										model.selected))))));
			case 'TriggerLoadMidiAndMp3':
				...
				return {
					...
					_1: A2(
						_elm_lang$core$Task$attempt,
						A3(_user$project$Main$LoadedMidiAndMp3, _p5._0, _p10, _p11),
						A2(
							_elm_lang$core$Task$andThen,
							function (mp3AudioBuf) {
								return A2(
									...
									_user$project$BinaryDecoder_File$fetchArrayBuffer(
										A2(_elm_lang$core$Basics_ops['++'], './contents/music/', _p10)));
							},
							A2(
								_elm_lang$core$Task$andThen,
								_user$project$WebAudioApi$decodeAudioData,
								_user$project$BinaryDecoder_File$fetchArrayBuffer(
									A2(_elm_lang$core$Basics_ops['++'], './contents/music/', _p11)))))
				};
			case 'LoadedMidiAndMp3':
				if (_p5._3.ctor === 'Ok') {
					var _p14 = _p5._3._0._1;
					var _p13 = _p5._3._0._0;
					var _p12 = A2(_user$project$BinaryDecoder_Byte$decode, _user$project$SmfDecoder$smf, _p14);
					if (_p12.ctor === 'Ok') {
						var midi = _user$project$Midi$fromSmf(_p12._0);
						return A2(
							_user$project$Core$andThen,
							_p5._0 ? A2(
								_elm_lang$core$Basics$flip,
								...
								_user$project$Main$MidiPlayerMsg(
									A2(_user$project$MidiPlayer$triggerStart, midi, _p13))),
							{
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									error: A2(_user$project$Main$DecodeError, _p14, _p12._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_p5._1,
										A2(_elm_lang$core$Basics_ops['++'], '\': ', _p5._3._0))))));
				}
			case 'Fullscreen':
				return {
					ctor: '_Tuple2',
			...
			case 'GitHubMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							gitHub: A2(_user$project$GitHub$update, _p5._0, model.gitHub)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A2(
					...
					A2(
						_elm_lang$core$Tuple$mapSecond,
						_elm_lang$core$Platform_Cmd$map(_user$project$Main$MidiPlayerMsg),
						A2(_user$project$MidiPlayer$update, _p5._0, model.midiPlayer)));
		}
	});
...
var _user$project$Main$init = function (location) {
	return A2(
		...
		function (gitHub) {
				...
				function (id) {
					return _elm_lang$core$List$head(
						A2(
							...
							function (content) {
								return _elm_lang$core$Native_Utils.eq(content.id, id);
							},
							_user$project$MusicContents$contents));
				},
				A2(
			...
			var model = A6(_user$project$Main$Model, _user$project$Main$initialMidiCountents, _elm_lang$core$Maybe$Nothing, _user$project$MidiPlayer$init, gitHub, false, _user$project$Main$NoError);
			var _p17 = firstContent;
			if (_p17.ctor === 'Just') {
				var _p18 = _p17._0;
				return A2(
					_user$project$Core$andThen,
					function (model) {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: _user$project$Main$moveToCard(_p18.id)
						};
					},
					A2(
						_user$project$Main$update,
						A2(_user$project$Main$OpenPlayer, true, _p18),
						model));
			} else {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			}
