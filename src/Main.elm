...
contents =
    ...
    , Content "#little-world" "Little World" (Just "field.jpg") (SoundCloud "306090165")
      -- 2016
    , Content "#hokora" "ほこら" (Just "hokora.jpg") (MidiAndMp3 "2016/hokora.mid" "2016/hokora.mp3" 2770)
    , Content "#hokora-fc" "ほこら (FCアレンジ by ハイデンさん)" (Just "hokora.jpg") (Mp3 "2016/hokora-fc.mp3")
    , Content "#kira-kira" "Kira Kira" Nothing (SoundCloud "278194362")
    , Content "#candy" "Candy" Nothing (SoundCloud "240810123")
      -- block
    , Content "#ancient" "ancient" (Just "block.png") (Mp3 "2016/ancient.mp3")
      -- , Content "#beach" "beach" (Just "block.png") (Mp3 "2016/beach.mp3")
    , Content "#cloud" "cloud" (Just "block.png") (Mp3 "2016/cloud.mp3")
    , Content "#ice" "ice" (Just "block.png") (Mp3 "2016/ice.mp3")
    , Content "#jungle" "jungle" (Just "block.png") (Mp3 "2016/jungle.mp3")
      -- , Content "#kingdom" "kingdom" Nothing (Mp3 "2016/kingdom.mp3")
      -- , Content "#night" "night" Nothing (Mp3 "2016/night.mp3")
    , Content "#ninja" "ninja" (Just "block.png") (Mp3 "2016/ninja.mp3")
    , Content "#volcano" "volcano" (Just "block.png") (Mp3 "2016/volcano.mp3")
      -- 2015
