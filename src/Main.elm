...
contents =
    ...
    , Content "#midnight" "真夜中の暇つぶし" (MidiAndMp3 "2014/midnight.mid" "2014/midnight.mp3" 540)
      -- 2013
    , Content "#string" "糸" (MidiAndMp3 "2013/string.mid" "2013/string.mp3" 840)
    , Content "#autumn" "秋風" (MidiAndMp3 "2013/autumn.mid" "2013/autumn.mp3" 1100)
    , Content "#afternoon-caos" "午後のカオス" (MidiAndMp3 "2013/afternoon_caos.mid" "2013/afternoon_caos.mp3" 700)
    , Content "#michikusa" "道草" (MidiAndMp3 "2013/michikusa.mid" "2013/michikusa.mp3" 860)
    , Content "#tmp" "Temporary" (MidiAndMp3 "2013/tmp.mid" "2013/tmp.mp3" 1700)
    , Content "#hallucination" "幻覚" (MidiAndMp3 "2013/hallucination.mid" "2013/hallucination.mp3" 1200)
    , Content "#blue" "Blue" (MidiAndMp3 "2013/blue.mid" "2013/blue.mp3" 1660)
      -- 2012
    , Content "#painter" "変人" (MidiAndMp3 "2012/painter.mid" "2012/painter.mp3" 1800)
    , Content "#uploar" "大騒ぎ" (MidiAndMp3 "2012/uploar.mid" "2012/uploar.mp3" 0)
      -- , Content "#air" "air" (MidiAndMp3 "2012/air.mid" "2012/air.mp3" 0) -- TODO: call stack exceeded?
    ]
